...
import { computeStats, formatBytes } from "@/lib/graphir/stats";
import {
  FileCode,
  FileJson,
  FileImage,
...
import type { FileCategory } from "@/lib/graphir/types";
...
export function StatsPanel() {
  ...
  const sortedCategories = (Object.entries(stats.byCategory) as [FileCategory, number][])
    .filter(([, n]) => n > 0)
    .sort((a, b) => b[1] - a[1]);
