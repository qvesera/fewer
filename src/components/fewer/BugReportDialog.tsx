  ...
  const handleCopyUrl = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Paste it in your browser to file the issue.",
      });
    } catch {
      toast({
        title: "Could not copy",
        description: "Try the Submit button instead.",
        variant: "destructive",
      });
    }
  };
        ...
        <DialogFooter className="flex-col sm:flex-row flex-wrap gap-2 sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              ...
              disabled={isDisabled || !title.trim()}
              className="gap-1.5 cursor-pointer bg-gradient-to-r from-primary to-primary text-white transition-[colors,transform,box-shadow] hover:opacity-90 hover:shadow-lg  active:scale-[0.96]"
            >
