...
insert into public.content_pages
  (type, slug, title, description, content, author, date, tags, published)
values ('docs', 'graph-features', 'Graph Features', 'Deep dive into Fewer''s graph visualization: React Flow canvas, custom node types, layout engines, edge styles, and navigation features.', 'Fewer is a very feature-rich directory viewer. Here is a deep dive into all of its features:
