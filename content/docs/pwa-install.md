...
Fewer is a progressive web app. Once you open [app.fewer.directory](https://app.fewer.directory) in a supported browser, you can install it like a native app.
...
1. Open [app.fewer.directory](https://app.fewer.directory)
...
1. Open [app.fewer.directory](https://app.fewer.directory) in Safari
