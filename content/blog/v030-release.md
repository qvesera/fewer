...
Presets are just a starting point. Switch to **Custom** mode and get a structured editor with 15 color slots, each with its own opacity slider:
...
- 18 theme presets
- Structured custom theme editor (15 slots + per-color opacity)
